...
class __TwigTemplate_6eabbc79ba036bae1db0ba978c0966ad extends Template
{
    ...
    ";
        // line 8
        yield "    ";
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "message", [], "any", false, false, false, 8)) {
            // line 9
            yield "        <div class=\"alert-success\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "message", [], "any", false, false, false, 9), "html", null, true);
            yield "</div>
    ";
        }
        // line 11
        yield "    ";
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "error", [], "any", false, false, false, 11)) {
            // line 12
            yield "        <div class=\"alert-error\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "error", [], "any", false, false, false, 12), "html", null, true);
            yield "</div>
    ";
        }
        // line 14
    ...
    ";
        // line 16
        yield "    ";
        if (( !array_key_exists("user", $context) || (CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "role", [], "any", false, false, false, 16) != "Admin"))) {
            // line 17
