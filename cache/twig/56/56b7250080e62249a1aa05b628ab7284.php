...
<a href=\"";
        // line 24
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["BASE_URL"] ?? null), "html", null, true);
        yield "index.php?controller=entreprise&action=index\" class=\"btn btn-back\">⬅ Retour aux Entreprises</a>
</div>
</section>
...
<script>
  ...
  <script src=\"";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["BASE_URL"] ?? null), "html", null, true);
        yield "public/js/modifier-entreprise.js\"></script>
";
        return; yield '';
    }
    ...
    {
        return array (  121 => 31,  116 => 29,  108 => 24,  101 => 20,  96 => 18,  91 => 16,  86 => 14,  81 => 12,  76 => 10,  71 => 8,  64 => 6,  60 => 4,  56 => 3,  48 => 2,  37 => 1,);
    }
...
<section class=\"content\">
    ...
    <div class=\"back-button-container\">
<a href=\"{{ BASE_URL }}index.php?controller=entreprise&action=index\" class=\"btn btn-back\">⬅ Retour aux Entreprises</a>
</div>
</section>
...
<script>
  ...
  <script src=\"{{ BASE_URL }}public/js/modifier-entreprise.js\"></script>
{% endblock %}
